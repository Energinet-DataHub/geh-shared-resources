...
module "appi_shared" {
  source                = "git::https://github.com/Energinet-DataHub/geh-terraform-modules.git//azure/application-insights?ref=5.5.0"
  ...
  log_analytics_workspace_name = azurerm_log_analytics_workspace.log_workspace_shared.id 
