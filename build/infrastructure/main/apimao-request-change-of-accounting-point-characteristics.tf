...
module "apimao_request_change_of_accounting_point_characteristics" {
  ...
  display_name            = "Metering Point: Request change of accounting point characteristics"
  method                  = "POST"
  url_template            = "v1.0/cim/request-change-of-accounting-point-characteristics"
  policies                = [
    {
      xml_content = <<XML
        <policies>
