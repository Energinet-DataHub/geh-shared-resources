      ...
      xml_content = <<XML
        <policies>
          <inbound>
            ...
            <rewrite-uri template="/api/ChargeLinksIngestion" />
          </inbound>
        </policies>
      XML
    }
